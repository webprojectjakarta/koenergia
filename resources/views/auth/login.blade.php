  ...
  <head>
    ...
    <link rel="stylesheet" href="{{asset('asset/assset/vendors/iconfonts/puse-icons-feather/feather.css')}}">
    ...
    <div class="container-scroller">
      <div class="container-fluid page-body-wrapper full-page-wrapper auth-page">
        <div class="content-wrapper d-flex align-items-center auth theme-one">
          ...
          <h2 style="text-align: center;">Koenergia</h2>
          </div>
          <div class="col-lg-4 mx-auto">
              ...
              <p class="footer-text text-center" style="margin-top: 20px;color: #308ee0">Copyright © {{date('Y')}} Koenergia</p>
            </div>
          </div>
        </div>
