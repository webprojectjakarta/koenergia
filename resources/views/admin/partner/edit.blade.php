@section('js')
        ...
        <form method="post" action="{{ route('adminPartner.update', $data->id) }}" enctype="multipart/form-data">
            {{ csrf_field() }}
            {{ method_field('put') }}
        <div class="row">
                            ...
                            <div class="card-body">
                              <h4 class="card-title">Update Content</h4>
                                ...
                                <div class="form-group">
                                    ...
                                    <a href="{{route('adminPartner.index')}}" class="btn btn-light pull-right">Back</a>
                            </div>
                          </div>
                        </div>
                      </div>
