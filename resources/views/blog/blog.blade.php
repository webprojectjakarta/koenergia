            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12">
                    <div class="toggole-boxs">
                        ...
                        <div>
                            <p style="text-align:justify;">Untuk 1kWp (1000Wp) sistem, dibutuhkan 6m2 dengan berat 12kg/m2 tergantung ukuran modul fotovoltaik yang digunakan</p>
                        </div>
                        <h3>Berapa umur dari Sistem PLTS Atap? </h3>
                        <div>
                            <p style="text-align:justify;">Jika Sistem PLTS Atap dipasang dengan baik, sistem dapat beroperasi sampai dengan 20-25 tahun. Product Warranty dari Modul Fotovoltaik 10 tahun, Solar Inverter 5 tahun dengan warranty instalasi antara 1-2 tahun.</p>
                        </div>
                        <h3>Berapa persenkah penghematan tagihan listrik yang didapat jika memasang Sistem PLTS Atap? </h3>
                        <div>
                            <p style="text-align:justify;">Penghematan yang akan didapatkan diantara 30-50 persen dari tagihan listrik anda setiap bulannya.</p>
                        </div>
                        <h3>Siapa sajakah yang dapan melakukan pembangunan dan pemasangan Sistem PLTS Atap?  </h3>
                        <div>
                            <p style="text-align:justify;">Adapun pemasangan Sistem PLTS Atap wajib dilakukan oleh Badan Usaha dan lembaga milik pemerintah pusat atau lembaga milik pemerintah daerah yang sudah terdaftar sebagai Badan Usaha Jasa Penunjang Tenaga Listrik yang telah dipublikasikan pada laman Direktoran Jenderal Energi Baru, Terbarukan dan Konservasi Energi (Dirjen EBTKE), Direktorat Jenderal Ketenagalistrikan dan PT PLN (Persero).</p>
                        </div>
                        ...
                        <div>
                            <p style="text-align:justify;">Untuk konsultasi lebih lanjut bisa menghubungi team kita melalui messenger atau kirimkan pertanyaan ke massasurya.id@gmail.com. Team kita akan membantu anda untuk Check ukuran yang anda butuhkan, Select EPC Kontraktor yang sesuai untuk anda dan kemudian anda bisa Own sistem anda sendiri dengan mudah.</p>
                        </div>
                    </div>
                </div>
            </div>
